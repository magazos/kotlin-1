...
infix operator fun A.plus(<!UNUSED_PARAMETER!>a<!> : Any) {
  ...
  1.foo()
  true.<!OI;TYPE_INFERENCE_NO_INFORMATION_FOR_PARAMETER!>foo<!>(<!NI;NO_VALUE_FOR_PARAMETER, NI;NO_VALUE_FOR_PARAMETER, OI;NO_VALUE_FOR_PARAMETER, OI;NO_VALUE_FOR_PARAMETER!>)<!>
