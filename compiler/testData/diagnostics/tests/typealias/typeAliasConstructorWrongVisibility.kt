...
val test1 = <!NI;INVISIBLE_MEMBER, OI;INVISIBLE_MEMBER!>MyAlias<!>(1)
val test1a = <!NI;INVISIBLE_MEMBER, OI;INVISIBLE_MEMBER!>MyClass<!>(1)

val test2 = <!NI;INVISIBLE_MEMBER, OI;INVISIBLE_MEMBER!>MyAlias<!>("")
val test2a = <!NI;INVISIBLE_MEMBER, OI;INVISIBLE_MEMBER!>MyClass<!>("")

val test3 = MyAlias(1.0)
val test3a = MyClass(1.0)

class MyDerived : MyClass(1.0) {
    val test4 = <!NI;INVISIBLE_MEMBER, OI;INVISIBLE_MEMBER!>MyAlias<!>(1)
    val test4a = <!NI;INVISIBLE_MEMBER, OI;INVISIBLE_MEMBER!>MyClass<!>(1)
